...
### assignment 8
  describe "#iterative_search" do
    ...
    it "searches AddressBook for Bob iterative_search" do
      book.import_from_csv("entries.csv")
    ...
    it "searches AddressBook for Joe iterative_search" do
      book.import_from_csv("entries.csv")
    ...
    it "searches AddressBook for Sussie iterative_search" do
      book.import_from_csv("entries.csv")
